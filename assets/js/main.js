...
!(function($) {
  ...
  // Teacher Section mouseover
  $(function(){
    $('.col-3').mouseover(function(){
      $(this).children('.teacher-content').stop().fadeIn(1000);
    });
    $('.col-3').mouseout(function(){
      $(this).children('.teacher-content').stop().fadeOut(1000);
    });
  });
  ...
  // program tab menu 
  $('.tab-list>ul>.l1').click(function(){
    $('.program-tab-cont-slider').animate({marginTop:"0"},500);
  });
  $('.tab-list>ul>.l2').click(function(){
    $('.program-tab-cont-slider').animate({marginTop:"-330px"},500);
  });
  $('.tab-list>ul>.l3').click(function(){
    $('.program-tab-cont-slider').animate({marginTop:"-660px"},500);
  });
  $('.tab-list>ul>.l4').click(function(){
    $('.program-tab-cont-slider').animate({marginTop:"-990px"},500);
  });
